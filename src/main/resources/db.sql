...
INSERT INTO `customers` (customer_id,customer_name,customer_mobile,customer_email, customer_address) VALUES
    (2, 'Emma Maina', 254706294691, 'maina.emma.w@gmail.com', 'Nairobi');
INSERT INTO hotel (hotel_id, hotel_address, hotel_description,hotel_name, hotel_type) VALUES
    (1, 'Nakuru', '5 star', 'Sarova Hotel','5 start');